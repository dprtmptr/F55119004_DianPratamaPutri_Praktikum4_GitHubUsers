package com.f55119004.githubusers_f55119004;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("List of GitHub Users | F55119004");
        }
    ...
    private void getListUsers() {
        ...
        client.addHeader("Authorization", "token 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");
